        ...
        public static void RunSample17()
        {
            using (var package = new ExcelPackage())
            {
               ...
               "2016-03-18;6,25359;6,32400;8,47826;1,24381;9,26976;11,91322;1,05881;0,07370;2,02554;0,98439;5,59067;0,12063;1,00000;0,23538;2,86880;8,20950";
                ...
                List<ExcelNamedRange> excelNamedRanges = new List<ExcelNamedRange>();
                for (int i = 0; i < 8; i++)
                {
                    int col = i + 2;
                    ...
                    ExcelNamedRange excelNamedRange = new ExcelNamedRange($"namedRange_{i}", ws, ws, dataAddress, ws.Names.Count); //{ IsNameHidden = true };
